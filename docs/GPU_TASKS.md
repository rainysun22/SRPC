...
> **结果与发散发现见 results_e2_gpu/REPORT_E2_GPU_SUMMIT.md**（0.98M/1.92M 健康
> 终态 BPC 3.972/3.930；3.89M/8.01M/15.03M 分别在 step≈33/33/45 万突发发散，已定位为
> 自由推断饱和死锁失稳并复现；判据 1 待稳定性修复后重裁）。
